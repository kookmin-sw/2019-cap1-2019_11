        ...
        if ret:
            if cnt % 3 == 1 :
                    ...
                    if name == 'Unknown':
                       ...
                       # Extract the region of the image that contains the face
                        ...
                        if t_cnt == 0:
                            ...
                            width=right-left
                            height=bottom-top
                            rect=(int(0.95*left),int(top*0.95),int(width*1.20),int(height*1.18))
                ...
                for (top,right,bottom,left) in unKnown_box:
                    ...
                    print('##unKnown_box## top = ', top, ' left = ',left, ' bottom = ', bottom, 'right = ', right)
                ...
                for (top,right,bottom,left) in Known_box:
                    print('##Known boxes## top = ', top, ' left = ',left, ' bottom = ', bottom, 'right = ', right)
                    #
                    cv2.rectangle(frame, (left, top), (right, bottom), (0, 0, 255), 2)
                    if video_path == 'stream':
                        cv2.imshow("face", frame)
